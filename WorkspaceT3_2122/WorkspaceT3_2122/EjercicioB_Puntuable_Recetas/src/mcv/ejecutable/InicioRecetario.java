...
public class InicioRecetario {
	...
	EventQueue.invokeLater(new Runnable() {
			...
			@Override
			public void run() {
				VRecetario ventana = new VRecetario(); //para crear la ventana necesitamos los datos por parámetro
				...
				ControladorRecetario controlador = new ControladorRecetario(ventana,poIntroducir,poConsultar, liRecetas); //añadimos las 3 ventanas al controlador
